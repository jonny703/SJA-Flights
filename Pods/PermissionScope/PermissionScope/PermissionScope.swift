...
//        Permission for \(permission.prettyDescription) was denied.".localized
//        Please enable access to \(permission.prettyDescription) in the Settings app
        
        print("permission", permission.prettyDescription)
        
        let alert = UIAlertController(title: "Permission was denied.",
            message: "Please enable it in the Setting",
